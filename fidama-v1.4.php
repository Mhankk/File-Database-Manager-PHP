...
class FileManager {
    ...
    // If $path is absolute, use it directly; otherwise, append it to baseDir.
 ...
 * list tables, show table structure, and execute custom SQL queries.
 */
class DBManager {
    private $pdo;
...
// --------------------------------------------------
if ($menu == 'database') {
    // Save DB configuration if submitted.
    ...
    // If no configuration is stored, show the configuration form.
         ...
         <tbody>
             ...
             if ($files !== false) {
                 foreach ($files as $file) {
                     ...
                     // Get octal permission (e.g. 755, 644)
